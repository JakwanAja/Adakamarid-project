                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center h-14 gap-3">
                        ...
                        <div className="hidden lg:flex items-center gap-1 shrink-0">
                            ...
                            <div className="w-px h-5 mx-1" style={{ backgroundColor: '#EAE0DC' }} />
                        </div>

                        {/* Auth */}
                        {auth?.user ? (
                            <div className="flex items-center gap-2 shrink-0">
                                <span className="hidden sm:block text-sm font-medium truncate max-w-[100px]" style={{ color: '#2D1B18' }}>
                                    {auth.user.name}
                                </span>
                            ...
                            <button
                                ...
                                style={{ border: '1.5px solid #C0392B', color: '#C0392B', backgroundColor: 'transparent', whiteSpace: 'nowrap' }}
            ...
            <footer style={{ backgroundColor: '#2D1B18' }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <div>
                            <p className="text-xs font-bold uppercase tracking-wider mb-4" style={{ color: 'rgba(245,237,233,0.4)' }}>Layanan</p>
                        ...
                        <div>
                            <p className="text-xs font-bold uppercase tracking-wider mb-4" style={{ color: 'rgba(245,237,233,0.4)' }}>Tentang</p>
                            <p className="text-sm leading-relaxed" style={{ color: 'rgba(245,237,233,0.55)' }}>
