...
export default function SettingsIndex({ settings, pages }) {
    ...
    return (
        <AdminLayout title="Pengaturan">
            ...
            <div className="mb-7">
                <h2 className="text-xl font-semibold" style={{ color: '#2D1B18' }}>Pengaturan Platform</h2>
                <p className="text-sm mt-0.5" style={{ color: '#8C6B63' }}>Kelola identitas dan konten platform</p>
            </div>
            ...
            <div className="max-w-3xl space-y-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-1.5" style={{ color: '#2D1B18' }}>
                                Nama Platform <span style={{ color: '#C0392B' }}>*</span>
                            </label>
                            <input
                                type="text"
                                ...
                                onFocus={e => { if (!errors.platform_name) { e.target.style.borderColor = '#C0392B'; e.target.style.boxShadow = '0 0 0 3px rgba(192,57,43,0.1)'; }}}
                                onBlur={e => { if (!errors.platform_name) { e.target.style.borderColor = '#EAE0DC'; e.target.style.boxShadow = 'none'; }}}
                            />
                        ...
                        <div className="pt-4" style={{ borderTop: '1px solid #EAE0DC' }}>
                            <button
                                type="submit"
                                disabled={processing}
                ...
                {/* ── Halaman Konten ── */}
                <div className="bg-white rounded-xl p-6" style={{ border: '1px solid #EAE0DC' }}>
                    <h3 className="text-base font-semibold mb-1" style={{ color: '#2D1B18' }}>Halaman Konten</h3>
                    ...
                    <div className="space-y-3">
                        {pages?.map(page => (
                            <div key={page.id}
                                ...
                                style={{ border: '1px solid #EAE0DC', backgroundColor: '#FAFAF9' }}>
